...
class CertificateParameters(BaseModel):
    ...
    RollNo: str = Field(..., description='Roll Number', examples=['99999999'])
...
class DipcrCertificatePostRequest(BaseModel):
...
class DipcrCertificatePostResponse(BaseModel):
...
class DipcrCertificatePostResponse1(BaseModel):
...
class DipcrCertificatePostResponse2(BaseModel):
...
class DipcrCertificatePostResponse3(BaseModel):
...
class DipcrCertificatePostResponse4(BaseModel):
...
class DipcrCertificatePostResponse5(BaseModel):
...
class DipcrCertificatePostResponse6(BaseModel):
